        ...
        btnSignUpCreateYourAccountPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(firstName.isEmpty()) {
                    Toast.makeText(ActivityRegisterPage.this, "First Name field is empty.", Toast.LENGTH_SHORT).show();
                    editTextFirstName.requestFocus();
                    return;
                }

                if(email.isEmpty()) {
                    Toast.makeText(ActivityRegisterPage.this, "Email field is empty.", Toast.LENGTH_SHORT).show();
                    editTextEmail.requestFocus();
                    return;
                }

                if(password.isEmpty()) {
                    Toast.makeText(ActivityRegisterPage.this, "Password field is empty.", Toast.LENGTH_SHORT).show();
                    editTextPassword.requestFocus();
                    return;
                }

                if(confirmPassword.isEmpty()) {
                    Toast.makeText(ActivityRegisterPage.this, "Confirm Password field is empty.", Toast.LENGTH_SHORT).show();
                ...
                if(!isValidFirstName) {
                    Toast.makeText(ActivityRegisterPage.this, "First Name is not in right format.", Toast.LENGTH_SHORT).show();
                ...
                if(!isValidLastName) {
                    Toast.makeText(ActivityRegisterPage.this, "Last Name is not in right format.", Toast.LENGTH_SHORT).show();
                ...
                if(!isValidEmail) {
                    Toast.makeText(ActivityRegisterPage.this, "Email is not in right format.", Toast.LENGTH_SHORT).show();
                ...
                if(!isValidPhone) {
                    Toast.makeText(ActivityRegisterPage.this, "Phone number is not in right format.", Toast.LENGTH_SHORT).show();
                ...
                if(!isValidPassword) {
                    Toast.makeText(ActivityRegisterPage.this, "Password is not valid.", Toast.LENGTH_SHORT).show();
                ...
                if(!password.equals(confirmPassword)) {
                    Toast.makeText(ActivityRegisterPage.this, "Password doesn't match.", Toast.LENGTH_SHORT).show();
